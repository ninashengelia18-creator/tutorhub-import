    ...
    <section className="bg-secondary/30 py-16 md:py-20">
      <div className="container">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-foreground">{t("home.progressTitle")}</h2>
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
          {[
            ...
            <motion.div
              ...
              className="rounded-xl border border-border bg-card p-6 text-center space-y-3 card-glow"
            >
              <span className="text-3xl">{feat.icon}</span>
              <h3 className="font-bold text-lg text-foreground">{t(feat.titleKey)}</h3>
