...
const socialLinks = [
  { icon: FacebookIcon, label: "Facebook", href: "https://facebook.com/learneazy" },
  { icon: InstagramIcon, label: "Instagram", href: "https://instagram.com/learneazy" },
  { icon: TikTokIcon, label: "TikTok", href: "https://tiktok.com/@learneazy" },
  { icon: YouTubeIcon, label: "YouTube", href: "https://youtube.com/@learneazy" },
];
