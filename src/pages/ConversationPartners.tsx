...
import { Heart, MessageCircle, Search, Star, Globe, Users, Briefcase, GraduationCap, Plane } from "lucide-react";
      ...
      <div className="container relative z-10 text-center max-w-3xl mx-auto">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
          ...
          <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
            Affordable, relaxed conversation sessions — no grammar drills, just real talk. Book a native speaker and start speaking with confidence today.
          </p>
          <Button size="lg" asChild>
            <a href="#browse">Find a Conversation Partner</a>
          </Button>
        </motion.div>
      </div>
    </section>
  ...
  return (
    <section className="container py-16 text-center max-w-2xl mx-auto">
      <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="rounded-3xl border bg-card p-10 space-y-4">
        ...
        <h2 className="text-3xl font-bold text-foreground">Are you a native speaker?</h2>
        <p className="text-muted-foreground text-lg">
          Earn money doing what you love — just having conversations. Set your own schedule and rate.
        </p>
        <Button size="lg" asChild>
...
export default function ConversationPartners() {
  return (
    <Layout>
      <HeroSection />
      <HowItWorksSection />
