...
import { Send, FileText, Video, BookOpen, PenTool } from "lucide-react";
...
export default function Classroom() {
  ...
  const handleSend = () => {
    ...
    setTimeout(() => {
      setMessages((prev) => [
        ...prev,
        { role: "tutor" as const, content: "That's a good question! Let me explain it step by step..." },
      ]);
    }, 1000);
  };
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground flex items-center gap-1">
                  <span className="h-1.5 w-1.5 rounded-full bg-success" /> Live Session
                </p>
              </div>
            </div>
          ...
          <div className="flex-1 flex overflow-hidden">
                  ...
                  <motion.div
                    ...
                    className={`max-w-[80%] rounded-lg px-3 py-2 text-sm ${
                      msg.role === "student"
                        ...
                        : msg.role === "system"
                        ? "mx-auto text-center text-xs text-muted-foreground bg-muted"
                        : "bg-muted"
                    }`}
                  >
                    {msg.content}
            ...
            <div className={`w-full md:w-80 border-l ${activeTab !== "notes" ? "hidden md:block" : "block"}`}>
              ...
              <textarea
                ...
                className="w-full h-[calc(100%-3rem)] p-3 text-sm bg-transparent outline-none resize-none"
