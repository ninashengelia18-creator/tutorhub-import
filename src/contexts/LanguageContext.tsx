...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "booking.choosePayment": "Choose how to pay",
    "booking.card": "Card",
    "booking.cardNumber": "Card number",
    "booking.expiry": "MM/YY",
    "booking.cvc": "CVC",
    "booking.bookAndPay": "Book lesson and pay",
    "booking.booking": "Booking...",
    "booking.agreePolicy": "By pressing the button, you agree to LearnEazy's Refund and Payment Policy.",
    "booking.sslSecure": "It's safe to pay on LearnEazy. All transactions are protected by SSL encryption.",
